...
1. Na barra de menus superior, selecione o **ícone de confidencialidade**, o ícone à direita do ícone de microfone (dependendo do tamanho da tela, pode ser necessário selecionar as reticências e a confidencialidade). Um banner amarelo na parte superior da página aparecerá e, na extremidade direita, um botão Selecionar etiqueta será exibido.  Selecione o botão **Selecionar etiqueta**.  Uma janela pop-up será exibida.   Selecione **Selecionar uma etiqueta** e, na lista suspensa, selecione **Confidencial – Finanças** e selecione **OK**.  
